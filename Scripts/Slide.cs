...
public partial class Slide : Control
{
    ...
    public override string[] _GetConfigurationWarnings()
    {
        ...
        if (GetChildOrNull<ColorRect>(0) == null || GetChildCount() != 1)
            Warning.Add("The slide must have only a ColorRect as its child.");
    ...
    public override void _Ready()
    {
        ...
        GetChild<ColorRect>(0).MouseExited += OnMouseExited;
